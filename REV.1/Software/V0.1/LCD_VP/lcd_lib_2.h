...
#define LCD_DATA_4  F, 4, _HI
#define LCD_DATA_5  F, 5, _HI
#define LCD_DATA_6  F, 6, _HI
#define LCD_DATA_7  F, 7, _HI

//управл€ющие выводы LCD
#define LCD_RS  F, 0, _HI
#define LCD_RW  D, 2, _NONE
#define LCD_EN  F, 1, _HI 
